        ...
        return [
            {
                ...
                title: 'Abas Mais Bonitas e Letras Brancas',
                description: 'Agora as 3 abas flutuantes (Agendamentos, Detalhes do Paciente e Cartões) ficaram mais lindas! O botão X (fechar) foi colocado no lugar certo no topo direito, e todas as letras ficaram brancas para você ler melhor no fundo escuro. Tudo fica mais fácil de entender e bonito de usar.',
                features: [
                    'Botão X no topo direito - Agora fica fácil de fechar as abas',
                    'Letras brancas em tema escuro - Tudo fica bem legível',
                    'Abas flutuantes padronizadas - Agendamentos, Paciente e Cartões iguais',
                    'Layout lado a lado - Informações na esquerda, conteúdo na direita',
                    'Cor verde no header - Verde Zenfisio em todos os headers',
                    'Fundo cinza escuro - Fundo que não cansa os olhos',
                    'Botão X branco - Aparece bem no header verde',
                    'Fundo das abas - Cinza escuro para melhor contraste',
                    'Texto grande e claro - Fácil de ler',
                    'Espaçamento bom - Nada muito apertado',
                    'Sem muitas animações - Interface rápida e responsiva',
                    'Funciona em todos os tamanhos - Celular, tablet, computador',
                    'Cores consistentes - Tudo combina com tudo',
                    'Botão X reativo - Muda de cor ao passar o mouse',
                    'Modal centralizado - Sempre no meio da tela',
                    'Overlay com blur - Fundo fica desfocado para destacar aba',
                    'Letras nas abas - Todas brancas para clareza',
                    'Labels e valores - Brancos para você entender o que é o quê',
                    'Cor de fechar - Branco para combinar com header verde',
                    'Tudo testado - Sem erros, pronto para usar'
                ],
                improvements: [
                    'Aba mais clara - Texto branco deixa tudo legível',
                    'Botão X no lugar - Canto superior direito, fácil de achar',
                    'Visual melhorado - Abas ficaram profissionais',
                    'Mais fácil usar - Tudo onde você espera encontrar',
                    'Cores que combinam - Verde + cinza-escuro + branco',
                    'Letras grandes - Fácil ler em qualquer tela',
                    'Design limpo - Sem poluição visual',
                    'Responsivo total - Funciona em todo lugar',
                    'Tema escuro - Protege seus olhos',
                    'Acessibilidade - Contraste alto',
                    'Pronto para usar - 100% funcional',
                    'Sem bugs - Testado em tudo',
                    'Rápido - Sem delay',
                    'Bonito - Designs profissional',
                    'Intuitivo - Fácil de entender',
                    'Organizado - Informações bem postas',
                    'Consistente - Tudo igual',
                    'Completo - 3 abas prontas',
                    'Documentado - Você sabe o que está usando',
                    'Atualizado - Versão 1.1.1 melhorada'
                ]
            },
            {
                version: '1.1.0',
